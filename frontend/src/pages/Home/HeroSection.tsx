...
function HeroSection() {
  ...
  const words = ["Adventure", "Career", "Traning", "Practice"];
  ...
  return (
    <section className="relative min-h-screen overflow-hidden">
      ...
      {/* Hero Content */}
      <div className="relative z-10 mx-4 sm:mx-[10%] top-60">

        <div className="flex flex-col gap-7 text-white w-full">

          <motion.h1 className="text-7xl font-medium max-w-xl leading-20"  initial={{ y: 60, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} transition={{ type: "spring", stiffness: 250, damping: 70, mass: 1, delay: 0.1 }}>
            Your Next Golf{" "} 
          ...
          <motion.p className="text-2xl max-w-2xl leading-8" initial={{ y: 60, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} transition={{ type: "spring", stiffness: 250, damping: 70, mass: 1, delay: 0.2 }}>
          ...
          <motion.div initial={{ y: 60, opacity: 0 }} whileInView={{ y: 0, opacity: 1 }} viewport={{ once: true }} transition={{ type: "spring", stiffness: 250, damping: 70, mass: 1, delay: 0.3 }}>
          <PrimaryButton className="flex items-center gap-3 py-3 text-xl! w-fit">
          ...
          <div className="grid grid-cols-3 w-full mt-10">
            ...
            <motion.div className="relative flex justify-center items-center text-black" initial={{ opacity: 0 }} whileInView={{ opacity: 1 }}  viewport={{ once: true }}  transition={{ type: "spring", stiffness: 250, damping: 70, mass: 1, delay: 0.5 }}>
              <motion.img animate={{rotate:360, scale: 1}} transition={{duration: 2, repeat: Infinity, ease: "linear",}} src={assets.glofball} className="h-40"></motion.img>
